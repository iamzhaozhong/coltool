//string interp
// const auth = 'appid=5YQ6LG-GH3HQ42U69&input='
...
async function makeRequest(str) {
  try {
    const res = await axios.get(`${proxy}${link}${auth}${str}&output=json`);
